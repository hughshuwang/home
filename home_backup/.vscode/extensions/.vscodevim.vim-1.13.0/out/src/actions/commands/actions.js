...
let CommandEsc = class CommandEsc extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (vimState.currentMode === mode_1.Mode.VisualLine && vimState.visualLineStartColumn !== undefined) {
                vimState.cursorStopPosition = vimState.cursorStopPosition.withColumn(vimState.visualLineStartColumn);
            }
            yield vimState.setCurrentMode(mode_1.Mode.Normal);
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            vimState.recordedState.transformations.push({
                ...
                text: textToAdd,
                position: position,
                diff: new position_1.PositionDiff({ character: -1 }),
            });
            yield vimState.setCurrentMode(mode_1.Mode.Normal);
            return vimState;
        });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            vimState.postponedCodeViewChanges.push({
                ...
                args: {
                    ...
                    value: timesToRepeat,
                    revealCursor: true,
                    select: mode_1.isVisualMode(vimState.currentMode),
                },
            });
            return vimState;
        });
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (vimState.currentMode === mode_1.Mode.Visual) {
                ...
                for (const { line } of position_1.Position.IterateLinesInBlock(vimState)) {
                    text += line + '\n';
                }
            }
...
let PutCommand = PutCommand_1 = class PutCommand extends BaseCommand {
    ...
    exec(position, vimState, after = false, adjustIndent = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let diff = new position_1.PositionDiff();
            if (vimState.currentMode === mode_1.Mode.VisualLine &&
                ...
                if (after) {
                    diff = new position_1.PositionDiff({
                        line: -numNewlines - 1,
                        character: numWhitespace,
                        type: position_1.PositionDiffType.ExactCharacter,
                    });
                }
                else {
                    diff = new position_1.PositionDiff({
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (vimState.effectiveRegisterMode === register_1.RegisterMode.LineWise &&
                ...
                result.recordedState.transformations.push({
                    type: 'moveCursor',
                    diff: new position_1.PositionDiff({ line: -numNewlines + 1 }),
    ...
    execCount(position, vimState) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (vimState.effectiveRegisterMode === register_1.RegisterMode.LineWise) {
                result.recordedState.transformations.push({
                    type: 'moveCursor',
                    diff: position_1.PositionDiff.newBOLDiff(addedLinesCount),
                    cursorIndex: this.multicursorIndex,
                });
            }
            return result;
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (vimState.lastVisualSelection !== undefined) {
                if (vimState.lastVisualSelection.end.line <= textEditor_1.TextEditor.getLineCount() - 1) {
                    yield vimState.setCurrentMode(vimState.lastVisualSelection.mode);
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            vimState.recordedState.transformations.push({
                ...
                text: resultLine,
                position: position,
                diff: new position_1.PositionDiff({ character: -lineTwo.length }),
            });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (toReplace === '<tab>') {
                ...
                vimState.recordedState.transformations.push({
                    ...
                    diff: new position_1.PositionDiff({ character: timesToRepeat - 1 }),
                });
            }
            return vimState;
        });
...
let ActionReplaceCharacterVisualBlock = class ActionReplaceCharacterVisualBlock extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const { start, end } of position_1.Position.IterateLinesInBlock(vimState)) {
                if (end.isBeforeOrEqual(start)) {
                    continue;
                }
                vimState.recordedState.transformations.push({
...
let ActionDeleteVisualBlock = class ActionDeleteVisualBlock extends BaseCommand {
    constructor() {
        super(...arguments);
        this.modes = [mode_1.Mode.VisualBlock];
        this.keys = [['d'], ['x'], ['X']];
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            const lines = [];
            for (const { line, start, end } of position_1.Position.IterateLinesInBlock(vimState)) {
                lines.push(line);
                vimState.recordedState.transformations.push({
                    type: 'deleteRange',
...
let ActionShiftDVisualBlock = class ActionShiftDVisualBlock extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            for (const { start } of position_1.Position.IterateLinesInBlock(vimState)) {
                vimState.recordedState.transformations.push({
                    type: 'deleteRange',
...
let ActionGoToInsertVisualBlockMode = class ActionGoToInsertVisualBlockMode extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            vimState.isMultiCursor = true;
            vimState.isFakeMultiCursor = true;
            for (const { line, start } of position_1.Position.IterateLinesInBlock(vimState)) {
...
let ActionChangeToEOLInVisualBlockMode = class ActionChangeToEOLInVisualBlockMode extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            vimState.isMultiCursor = true;
            vimState.isFakeMultiCursor = true;
            for (const { end } of position_1.Position.IterateLinesInBlock(vimState)) {
...
let ActionGoToInsertVisualBlockModeAppend = class ActionGoToInsertVisualBlockModeAppend extends BaseCommand {
    ...
    exec(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            vimState.isMultiCursor = true;
            vimState.isFakeMultiCursor = true;
            for (const { line, end } of position_1.Position.IterateLinesInBlock(vimState)) {
                if (line.trim() === '') {
                    vimState.recordedState.transformations.push({
                        type: 'replaceText',
