...
let CommandNextSearchMatch = class CommandNextSearchMatch extends baseMotion_1.BaseMovement {
    ...
    execAction(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!nextMatch) {
                throw error_1.VimError.fromCode(searchState.searchDirection === searchState_1.SearchDirection.Forward
    ...
    execAction(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (mark.isUppercaseMark && mark.editor !== undefined) {
                yield ensureEditorIsActive(mark.editor);
            }
...
let BackSpaceInVisualMode = class BackSpaceInVisualMode extends baseMotion_1.BaseMovement {
    constructor() {
        super(...arguments);
        this.modes = [mode_1.Mode.Visual, mode_1.Mode.VisualBlock];
        this.keys = ['<BS>'];
    }
    execAction(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
...
let MoveRight = class MoveRight extends baseMotion_1.BaseMovement {
    ...
    execAction(position, vimState) {
        return __awaiter(this, void 0, void 0, function* () {
            if (wrapping_1.shouldWrapKey(vimState, this.keysPressed)) {
                const includeEol = vimState.currentMode === mode_1.Mode.Insert;
...
let MoveUpByDisplayLine = class MoveUpByDisplayLine extends MoveByScreenLine {
    constructor() {
        super(...arguments);
        this.modes = [mode_1.Mode.Insert, mode_1.Mode.Normal, mode_1.Mode.Visual];
        this.keys = [
            ['g', 'k'],
            ['g', '<up>'],
        ];
...
let MoveScreenToRight = class MoveScreenToRight extends MoveByScreenLine {
    constructor() {
        super(...arguments);
        this.modes = [mode_1.Mode.Insert, mode_1.Mode.Normal, mode_1.Mode.Visual, mode_1.Mode.VisualLine];
        this.keys = ['z', 'h'];
