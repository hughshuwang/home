...
var ToggleCaseOperator_1, ROT13Operator_1, ActionVisualReflowParagraph_1;
...
let DeleteOperator = class DeleteOperator extends BaseOperator {
    ...
    delete(start, end, currentMode, registerMode, vimState, yank = true) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (currentMode === mode_1.Mode.Visual) {
            ...
            if (registerMode === register_1.RegisterMode.LineWise) {
                ...
                diff = new position_1.PositionDiff({
                    type: position_1.PositionDiffType.ObeyStartOfLine,
                });
            }
    ...
    run(vimState, start, end) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (vimState.surround) {
                ...
                yield vimState.setCurrentMode(mode_1.Mode.SurroundInputMode);
            ...
            register_1.Register.put(text, vimState, this.multicursorIndex);
            if (vimState.currentMode === mode_1.Mode.Visual || vimState.currentMode === mode_1.Mode.VisualLine) {
            ...
            if (originalMode === mode_1.Mode.Normal && !moveCursor) {
...
let ChangeOperator = class ChangeOperator extends BaseOperator {
    ...
    run(vimState, start, end) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (textEditor_1.TextEditor.getLineLength(textEditor_1.TextEditor.getLineAt(start).lineNumber) !== 0 ||
                end.line !== start.line) {
                if (isLineWise) {
    ...
    run(vimState, start, end) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const range of selections) {
                const original = textEditor_1.TextEditor.getText(range);
                vimState.recordedState.transformations.push({
                    type: 'replaceText',
                    text: ROT13Operator_1.rot13(original),
...
ROT13Operator = ROT13Operator_1 = __decorate([
    base_1.RegisterAction
], ROT13Operator);
